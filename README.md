...
**Reasonix Migration Assistant** — Reasonix upgrades without amnesia. One command — every conversation, skill, and memory comes with you.

Major version upgrades shouldn't mean starting over. Migration Assistant moves all your AI data — conversations, MCP config, memories, skills — from old Reasonix to new in a single command.

### What Gets Migrated
- MCP server configuration  •  Conversation history
- Project & global memories  •  Installed skills

### Safety
- Auto-backup to `.backup/` before any operation
- Dry-run preview mode  •  Old files kept untouched
